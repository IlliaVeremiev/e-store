...
public class EncryptionHelper {
    ...
    private static final int KEY_ITERATION_COUNT = 100_000; //TODO https://security.stackexchange.com/q/3959
    ...
    @SneakyThrows
    public static byte[] encrypt(@NonNull SecretKey key, byte[] clearText) {
    ...
    @SneakyThrows
    public static byte[] decrypt(@NonNull SecretKey key, byte[] cipherText) {
